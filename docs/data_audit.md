...
Le module `src/validation/audit.py` (à écrire, prochaine étape du projet) rassemblera
les règles et s'exécutera **avant** tout traitement. Il bloquera le pipeline si une
donnée est invalide et journalisera le résultat dans `outputs/tables/audit_report.csv`
